export const events = [
  {
    ...
    start: new Date('2022-08-15 10:00:00').getTime(),
    end: new Date('2022-08-15 11:00:00').getTime(),
  },
  {
    id: '2',
    title: 'Junta con el equipo de desarrollo',
    notes: 'Se planeará las los tickets para el próximo sprint',
    start: new Date('2022-08-16 10:00:00').getTime(),
    end: new Date('2022-08-16 11:00:00').getTime(),
  },
];
